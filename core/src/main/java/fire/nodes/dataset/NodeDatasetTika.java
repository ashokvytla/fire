...
import fire.util.fileformats.tika.TikaFileInputFormat;
...
public class NodeDatasetTika extends NodeDatasetFileOrDirectory implements Serializable {
    ...
    public NodeDatasetTika(int i, String nm, String p) {
        super(i, nm, p);
    }

    public NodeDatasetTika(int i, String nm, String p, String cols, String colTypes, String colmlTypes) {
        super(i, nm, p, cols, colTypes);
    }

    public NodeDatasetTika()
    {
    ...
    public void execute(JavaSparkContext ctx, SQLContext sqlContext, WorkflowContext workflowContext, DataFrame df) {
        ...
        workflowContext.out("Executing NodeDatasetTika : " + id);

        JavaPairRDD<Text, Text> pairRDD = ctx.newAPIHadoopFile(path, TikaFileInputFormat.class,
