...
public class WorkflowTika {
    ...
    public static void main(String[] args) {
        ...
        tikawf(ctx, sqlContext, workflowContext);
    ...
    private static void tikawf(JavaSparkContext ctx, SQLContext sqlContext, WorkflowContext workflowContext) {

        Workflow wf = new Workflow();

        // pdf node
        NodeDatasetTika tika = new NodeDatasetTika(1, "tika node", "data/pdf-sample.pdf");
        wf.addNodeDataset(tika);
